...
void bind_PyPlaceDB(pybind11::module& m) 
{
    pybind11::class_<DREAMPLACE_NAMESPACE::PyPlaceDB>(m, "PyPlaceDB")
        ...
        .def_readwrite("cascade_shape_name2id_map", &DREAMPLACE_NAMESPACE::PyPlaceDB::cascade_shape_name2id_map)
        ...
        .def_readwrite("cascade_inst_name2id_map", &DREAMPLACE_NAMESPACE::PyPlaceDB::cascade_inst_name2id_map)
