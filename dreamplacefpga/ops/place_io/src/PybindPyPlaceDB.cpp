...
void bind_PyPlaceDB(pybind11::module& m) 
{
    pybind11::class_<DREAMPLACE_NAMESPACE::PyPlaceDB>(m, "PyPlaceDB")
        ...
        .def_readwrite("original_node_names", &DREAMPLACE_NAMESPACE::PyPlaceDB::original_node_names)
        ...
        .def_readwrite("original_node_types", &DREAMPLACE_NAMESPACE::PyPlaceDB::original_node_types)
        ...
        .def_readwrite("original_node_name2id_map", &DREAMPLACE_NAMESPACE::PyPlaceDB::original_node_name2id_map)
        .def_readwrite("original_node2node_map", &DREAMPLACE_NAMESPACE::PyPlaceDB::original_node2node_map)
        .def_readwrite("org_cascade_node_x_offset", &DREAMPLACE_NAMESPACE::PyPlaceDB::org_cascade_node_x_offset)
        .def_readwrite("org_cascade_node_y_offset", &DREAMPLACE_NAMESPACE::PyPlaceDB::org_cascade_node_y_offset)
        ...
        .def_readwrite("bramSiteXYs", &DREAMPLACE_NAMESPACE::PyPlaceDB::bramSiteXYs)
        .def_readwrite("uramSiteXYs", &DREAMPLACE_NAMESPACE::PyPlaceDB::uramSiteXYs)
        ...
        .def_readwrite("num_physical_constraints", &DREAMPLACE_NAMESPACE::PyPlaceDB::num_physical_constraints)
        .def_readwrite("num_region_constraint_boxes", &DREAMPLACE_NAMESPACE::PyPlaceDB::num_region_constraint_boxes)
        .def_readwrite("region_box2xl", &DREAMPLACE_NAMESPACE::PyPlaceDB::region_box2xl)
        .def_readwrite("region_box2yl", &DREAMPLACE_NAMESPACE::PyPlaceDB::region_box2yl)
        .def_readwrite("region_box2xh", &DREAMPLACE_NAMESPACE::PyPlaceDB::region_box2xh)
        .def_readwrite("region_box2yh", &DREAMPLACE_NAMESPACE::PyPlaceDB::region_box2yh)
        .def_readwrite("constraint2node_map", &DREAMPLACE_NAMESPACE::PyPlaceDB::constraint2node_map)
        .def_readwrite("flat_constraint2box", &DREAMPLACE_NAMESPACE::PyPlaceDB::flat_constraint2box)
        .def_readwrite("flat_constraint2box_start", &DREAMPLACE_NAMESPACE::PyPlaceDB::flat_constraint2box_start)
        .def_readwrite("flat_constraint2node", &DREAMPLACE_NAMESPACE::PyPlaceDB::flat_constraint2node)
        .def_readwrite("flat_constraint2node_start", &DREAMPLACE_NAMESPACE::PyPlaceDB::flat_constraint2node_start)
        .def_readwrite("cascade_shape_names", &DREAMPLACE_NAMESPACE::PyPlaceDB::cascade_shape_names)
        .def_readwrite("cascade_shape_heights", &DREAMPLACE_NAMESPACE::PyPlaceDB::cascade_shape_heights)
        .def_readwrite("cascade_shape_widths", &DREAMPLACE_NAMESPACE::PyPlaceDB::cascade_shape_widths)
        .def_readwrite("cascade_shape2macro_type", &DREAMPLACE_NAMESPACE::PyPlaceDB::cascade_shape2macro_type)
        .def_readwrite("cascade_inst_names", &DREAMPLACE_NAMESPACE::PyPlaceDB::cascade_inst_names)
        .def_readwrite("cascade_inst2shape", &DREAMPLACE_NAMESPACE::PyPlaceDB::cascade_inst2shape)
        .def_readwrite("cascade_inst2org_node_map", &DREAMPLACE_NAMESPACE::PyPlaceDB::cascade_inst2org_node_map)
        .def_readwrite("cascade_inst2org_start_node", &DREAMPLACE_NAMESPACE::PyPlaceDB::cascade_inst2org_start_node)
        .def_readwrite("original_macro_nodes", &DREAMPLACE_NAMESPACE::PyPlaceDB::original_macro_nodes)
        ;
