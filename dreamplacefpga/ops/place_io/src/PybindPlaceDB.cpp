...
void bind_PlaceDB(pybind11::module& m) 
{
    ...
    pybind11::class_<DREAMPLACE_NAMESPACE::PlaceDB> (m, "PlaceDB")
        ...
        .def("originalMovNodeName", (std::string const& (DREAMPLACE_NAMESPACE::PlaceDB::*)(DREAMPLACE_NAMESPACE::PlaceDB::index_type) const) &DREAMPLACE_NAMESPACE::PlaceDB::originalMovNodeName)
        ...
        .def("originalMovNodeType", (std::string const& (DREAMPLACE_NAMESPACE::PlaceDB::*)(DREAMPLACE_NAMESPACE::PlaceDB::index_type) const) &DREAMPLACE_NAMESPACE::PlaceDB::originalMovNodeType)
        ...
        .def("numBRAM", &DREAMPLACE_NAMESPACE::PlaceDB::numBRAM)
        .def("numURAM", &DREAMPLACE_NAMESPACE::PlaceDB::numURAM)
        .def("numPhysicalConstraints",&DREAMPLACE_NAMESPACE::PlaceDB::numPhysicalConstraints)
        .def("numRegionConstraintBoxes",&DREAMPLACE_NAMESPACE::PlaceDB::numRegionConstraintBoxes)
        .def("numCascadeShape",&DREAMPLACE_NAMESPACE::PlaceDB::numCascadeShape)
        .def("numCascadeInst",&DREAMPLACE_NAMESPACE::PlaceDB::numCascadeInst)
        ...
        .def("regionBoxXLows", (std::vector<double> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::regionBoxXLows)
        .def("regionBoxXl", (double const& (DREAMPLACE_NAMESPACE::PlaceDB::*)(DREAMPLACE_NAMESPACE::PlaceDB::index_type) const) &DREAMPLACE_NAMESPACE::PlaceDB::regionBoxXl)
        .def("regionBoxYLows", (std::vector<double> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::regionBoxYLows)
        .def("regionBoxYl", (double const& (DREAMPLACE_NAMESPACE::PlaceDB::*)(DREAMPLACE_NAMESPACE::PlaceDB::index_type) const) &DREAMPLACE_NAMESPACE::PlaceDB::regionBoxYl)
        .def("regionBoxXHighs", (std::vector<double> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::regionBoxXHighs)
        .def("regionBoxXh", (double const& (DREAMPLACE_NAMESPACE::PlaceDB::*)(DREAMPLACE_NAMESPACE::PlaceDB::index_type) const) &DREAMPLACE_NAMESPACE::PlaceDB::regionBoxXh)
        .def("regionBoxYHighs", (std::vector<double> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::regionBoxYHighs)
        .def("regionBoxYh", (double const& (DREAMPLACE_NAMESPACE::PlaceDB::*)(DREAMPLACE_NAMESPACE::PlaceDB::index_type) const) &DREAMPLACE_NAMESPACE::PlaceDB::regionBoxYh)
        .def("flatConstraint2Box", (std::vector<DREAMPLACE_NAMESPACE::PlaceDB::index_type> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::flatConstraint2Box)
        .def("flatConstraint2BoxStart", (std::vector<DREAMPLACE_NAMESPACE::PlaceDB::index_type> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::flatConstraint2BoxStart)
        .def("constraint2NodeMap", (std::vector<std::vector<DREAMPLACE_NAMESPACE::PlaceDB::index_type> > const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::constraint2NodeMap)
        .def("flatConstraint2Node", (std::vector<DREAMPLACE_NAMESPACE::PlaceDB::index_type> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::flatConstraint2Node)
        .def("flatConstraint2NodeStart", (std::vector<DREAMPLACE_NAMESPACE::PlaceDB::index_type> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::flatConstraint2NodeStart)
        .def("cascadeShapeNames", (std::vector<std::string> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::cascadeShapeNames)
        .def("cascadeShapeName", (std::string const& (DREAMPLACE_NAMESPACE::PlaceDB::*)(DREAMPLACE_NAMESPACE::PlaceDB::index_type) const) &DREAMPLACE_NAMESPACE::PlaceDB::cascadeShapeName)
        .def("cascadeShapeHeights", (std::vector<double> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::cascadeShapeHeights)
        .def("cascadeShapeWidths", (std::vector<double> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::cascadeShapeWidths)
        .def("cascadeShape2MacroType", (std::vector<std::string> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::cascadeShape2MacroType)
        .def("cascadeInstNames", (std::vector<std::string> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::cascadeInstNames)
        .def("cascadeInst2Shape", (std::vector<DREAMPLACE_NAMESPACE::PlaceDB::index_type> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::cascadeInst2Shape)
        ...
        .def("orgCascadeNodeXoffset", (std::vector<double> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::orgCascadeNodeXoffset)
        .def("orgCascadeNodeYoffset", (std::vector<double> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::orgCascadeNodeYoffset)
        .def("cascadeInst2OrgNodeMap", (std::vector<std::vector<DREAMPLACE_NAMESPACE::PlaceDB::index_type> > const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::cascadeInst2OrgNodeMap)
        .def("cascadeInst2OrgStartNode", (std::vector<DREAMPLACE_NAMESPACE::PlaceDB::index_type> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::cascadeInst2OrgStartNode)
        .def("orgMacroNodes", (std::vector<DREAMPLACE_NAMESPACE::PlaceDB::index_type> const& (DREAMPLACE_NAMESPACE::PlaceDB::*)() const) &DREAMPLACE_NAMESPACE::PlaceDB::orgMacroNodes)
        ;
}
