...
class BookshelfDataBase
{
	public:
        ...
        virtual void resize_clk_regions(int, int);
        ///@brief update clock regions
        virtual void add_clk_region(string const&, int, int, int, int, int, int);
        /// @brief add lib cell
        ...
        /// @brief end of cascade instance
        virtual void end_of_cascade_inst() = 0;
        /// @brief add macro
